package kr.co.hugo.common.crawler.restinfo;
...
import kr.co.hugo.common.crawler.restinfo.controller.RestInfoController;
...
public class RestInfoCrawler {
	...
	@Autowired
	private static RestInfoController reInfoController;
