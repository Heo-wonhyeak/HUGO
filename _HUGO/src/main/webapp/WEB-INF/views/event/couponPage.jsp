...
<body>
	<table align="center" width="95%">
		<tr align="center">
			...
			<td width="30%" id="selectTd" class="eventTd" onclick="location.href='${contextPath}/event/couponPage.do'">
				쿠폰
			</td>
		</tr>
	</table>
	...
	<table align="center" width="90%">
		...
		<tr align="center">
			<td>
				<img src="${contextPath }/resources/img/cuteDog.jpeg" alt="강아지 사진" class="picture"/>
				<div class="enterTitle" onclick="location.href='${contextPath}/event/couponDTL.do'">
