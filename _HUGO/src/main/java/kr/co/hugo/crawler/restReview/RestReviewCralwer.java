package kr.co.hugo.crawler.restReview;
...
public class RestReviewCralwer {
	public static void main(String[] args) {
		...
		try {
			...
			int count=0;
			Elements ele = html.select(".RestaurantReviewItem RestaurantReviewList__ReviewItem");
			...
			// 식당이름
			String userName="23";
			if(!(html.getElementsByClass("RestaurantReviewList__ReviewItem")).isEmpty()){
